...
const Page: React.FC = () => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "ParticipantRegsm24istrationData.xlsx");
  };
  ...
  return (
    <div className="bg-white min-w-full min-h-screen flex flex-col justify-center items-center mt-4 p-2 flex-wrap">
